...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        # FORMATION state
            ...
            # Drone's coordinates
            h = current_pose1.pose.position.z + t1[2]
            ...
            # Shut down
            if (current_time.to_sec()-t_start) >= 60:
                rospy.loginfo("[Drone1] Time limit reached. Shutting down simulation at t=60")
                break
            ...
            # Record data
            log_data.append((current_time.to_sec()-t_start, ep[0], ep[1], ep[2], z_norm[0], z_norm[1], z_norm[2],x1, y1, h))
