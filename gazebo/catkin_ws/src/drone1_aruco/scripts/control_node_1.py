...
def main():
    ...
    yaw_pid = cf.PID(Kp=0.022, Ki=0.0, Kd=0.001, dt=0.01, output_limits=(-0.5, 0.5))
    image_centre = 800/2
    ...
    d = np.array([np.sqrt(16), np.sqrt(16), np.sqrt(16)])  # desired edge lengths
    ...
    while not rospy.is_shutdown():
        ...
        # FORMATION state
            ...
            if new_data:
                ...
                # Record data
                log_data.append((current_time.to_sec()-t_start, ep[0], ep[1], ep[2], z_norm[0], z_norm[1], z_norm[2], h))
